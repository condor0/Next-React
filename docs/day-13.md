...
- **Project detail** (`app/(app)/projects/[id]/page.tsx`): Replaced static metadata with `generateMetadata()` that reads the project name from the data store, producing dynamic titles like *"Project Alpha | Research Workspace"*.
